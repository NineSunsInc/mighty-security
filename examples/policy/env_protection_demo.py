...
from src.policies.manager import PolicyManager, Policy, PolicyResult
from src.policies.parser import PolicyParser, PolicyLanguage
...
class AdversarialTester:
    ...
    async def attack_response_containing_secrets(self):
        ...
        for secret_content in secret_responses:
            ...
            self.attack_results.append((f"secret_response", success, result.reason))
