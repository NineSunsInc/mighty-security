...
class MCPSpecificAnalyzer:
    ...
    def _check_dangerous_combinations(self, capabilities: dict) -> dict | None:
...
class PromptInjectionDetector:
    ...
    def _detect_encoded_injection(self, content: str) -> str | None:
        import base64
...
class CodeBehaviorAnalyzer:
    ...
    def _detect_exfiltration(self, tree: ast.AST) -> str | None:
