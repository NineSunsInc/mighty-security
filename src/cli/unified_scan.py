...
class UnifiedScanner:
    ...
    async def scan_mcp_configs(self, client: str | None = None) -> dict:
        """
...
def unified_scan_command(target: str | None, github: str | None,
                        client: str | None, enable_llm: bool,
                        enable_ml: bool, check_policies: bool,
                        update_signatures: bool, output: str | None,
                        format: str):
    """
