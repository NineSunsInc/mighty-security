...
from .base_analyzer import BaseLLMAnalyzer, LLMRequest, LLMResponse, AnalysisType
from .vulnerability_learner import AdvancedVulnerabilityDetector, VulnerabilityClass
            ...
            for sink in self.context.sensitive_sinks[:5]:
                ...
                chain = {
                    ...
                    'steps': [
                        ...
                        f"2. Input flows through application",
                        f"3. Reaches {sink.get('location', 'unknown')} without sanitization",
                        f"4. Executes malicious payload"
                    ],
                    'severity': 'HIGH',
                    'confidence': 0.7
                }
